...
const PayYourRentOnline = () => {
  return (
    <div className="grid sm:grid-cols-5 gap-5 items-center lg:gap-10 p-5 md:p-10">
      <div className="w-full sm:col-span-2">
        <img
          src="math-blocks-house-key-stacked-coins-wooden-surface1.png"
          alt="math-blocks-house-key-stacked-coins-wooden-surface1.png"
...
export default PayYourRentOnline;
