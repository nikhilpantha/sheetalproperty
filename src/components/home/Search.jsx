  ...
  return (
    <>
      <div className="flex justify-center px-5 md:px-10">
        <div className="w-full xl:w-9/12 -mt-20 md:-mt-40 bg-white rounded shadow-xl border border-gray-100 p-3 xs:p-7  md:p-16 lg:space-y-5">
          ...
          <div className="border-2 md:text-xl border-gray-600 flex items-center rounded-md bg-white hover:border-gray-900 focus:ring-2 focus:ring-red-700 overflow-hidden space-x-2 xs:space-x-5">
            ...
            <div className="p-3 xs:p-5 md:p-7 h-full space-x-3 font-medium text-xl flex items-center bg-red-700 text-white">
